...
$data = array(
    ...
    "TRANSACTIONID" => "042066995V5760459",
    "VERSION"       => "74.0"
);
...
elseif($body->ACK != "Success") {
    if($body->L_LONGMESSAGE0 == "The transaction id is not valid") die("NULL");
    else die("Error: {$body->L_SHORTMESSAGE0} - {$body->L_LONGMESSAGE0}");
} else {
    echo "EMAIL: " . $body->EMAIL;
    echo "<hr />";
    echo "TRANSACTIONTYPE: " . $body->TRANSACTIONTYPE;
    echo "<hr />";
    echo "PAYMENTTYPE: " . $body->PAYMENTTYPE;
    echo "<hr />";
    echo "AMT: " . $body->AMT;
    echo "<hr />";
    echo "FEEAMT: " . $body->FEEAMT;
    echo "<hr />";
    echo "CURRENCYCODE: " . $body->CURRENCYCODE;
    echo "<hr />";
    echo "PAYMENTSTATUS: " . $body->PAYMENTSTATUS;
    echo "<hr />";
    echo "PENDINGREASON: " . $body->PENDINGREASON;
